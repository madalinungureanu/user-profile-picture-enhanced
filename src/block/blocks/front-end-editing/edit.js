...
class User_Profile_Picture_Enhanced_Front_End_Editing extends Component {
	...
	render() {
		return (
			<Fragment>
				...
				<div>
					{__('Publish for front-end editing', 'user-profile-picture-enhanced')}
				</div>
			</Fragment>
		);
	}
}
export default User_Profile_Picture_Enhanced_Front_End_Editing;